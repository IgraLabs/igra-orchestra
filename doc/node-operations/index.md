...
- **[Reth Upgrade: 1.9.3 → 2.5.1](upgrade-reth-1.9-to-2.5.md)** - Drop the execution-layer database and resync when `RETH_VERSION` moves to the `2.5.1-igra.<n>` line; kaspad data is preserved (12+ hours, L2 RPC offline)
