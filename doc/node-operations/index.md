...
- **[Read-Only RPC Node](readonly-rpc-node.md)** - Minimal read-only kaspad + pruned execution-layer stack for co-location on a hardened host; no published ports, fail-closed read-only endpoint, bounded history on both layers
