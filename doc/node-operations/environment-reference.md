...
| `IGRA_LANE_ID` | `.env` | Canonical post-KIP21 dedicated IGRA lane id, currently `97b10000` (8-char namespace shorthand; kaspad zero-pads to 20 bytes); passed to kaspad as `--igra-lane-id` and used as the ATAN import/upload namespace |
